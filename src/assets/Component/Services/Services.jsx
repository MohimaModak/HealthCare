  ...
  return (
    <div id='/Services' className='w-full bg-blue-50 h-auto py-20 px-10'>
      <div data-aos="fade-up" className='max-w-6xl mx-auto'>
        <h1 data-aos="fade-up" className='text-3xl lg:text-4xl font-bold text-center mb-10'>Our Medical Services</h1>
       


        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {/* Service Card 1: Find a Specialist */}
          <div data-aos="fade-up" className='bg-white rounded-se-full rounded-b-full p-6 text-center shadow-lg hover:shadow-xl transition-shadow duration-300'>

...
export default function Insurance() {
  ...
  return (
    ...
    <section id="/Insurance" className="w-full bg-blue-50 py-20 px-10 text-black">
      <div data-aos="fade-up" className="max-w-6xl mx-auto flex flex-col  lg:flex-row items-center">

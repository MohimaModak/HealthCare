        ...
        <div className='lg:flex justify-center items-center lg:gap-10'>
          <div className=''>
            <div className='flex items-center text-center lg:text-left'>
              <h1 data-aos="fade-up" className='text-3xl font-bold text-center lg:text-left'>Committed to Excellence in 
                <div data-aos="fade-up" className='flex justify-center items-center '> <span className="text-blue-500 border-b-2 rounded-t-md border-blue-600 text-3xl">
                Healthcare
              </span>
            ...
            <div data-aos="fade-up" className='text-center lg:text-left mb-5 lg:mb-0'>
          ...
          <div data-aos="fade-up" className='bg-blue-500 rounded-se-full rounded-b-full'>
